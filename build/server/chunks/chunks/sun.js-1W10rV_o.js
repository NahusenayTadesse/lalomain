import { X as attr, Y as head, Z as html, F as derived, _ as spread_props } from './index-server.js-BTqLeq8m.js';
import { M as MediaQuery, c as createSubscriber } from './index-server2.js-BPx0mTfA.js';
import './dist.js-B6Yn2WWx.js';
...
//#endregion
//#region node_modules/.pnpm/runed@0.25.0_svelte@5.56.8_@typescript-eslint+types@8.65.0_/node_modules/runed/dist/utilities/active-element/active-element.svelte.js
...
var PersistedState = class {
	...
	constructor(key, initialValue, options = {}) {
		...
		}, syncTabs = true, window = defaultWindow } = options;
...
//#endregion
//#region node_modules/.pnpm/mode-watcher@1.1.0_svelte@5.56.8_@typescript-eslint+types@8.65.0_/node_modules/mode-watcher/dist/modes.js
/**
...
//#endregion
//#region node_modules/.pnpm/mode-watcher@1.1.0_svelte@5.56.8_@typescript-eslint+types@8.65.0_/node_modules/mode-watcher/dist/without-transition.js
var timeoutAction;
var timeoutEnable;
/**
...
function Mode_watcher_full($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		head("15noc16", $$renderer, ($$renderer) => {
			if (themeColors) {
				$$renderer.push("<!--[0-->");
				$$renderer.push(`<meta name="theme-color"${attr("content", themeColors.dark)}/>`);
			} else $$renderer.push("<!--[-1-->");
...
export { Mode_watcher as M, Sun as S, Moon as a, derivedMode as d, resetMode as r, setMode as s, toggleMode as t };
//# sourceMappingURL=sun.js-1W10rV_o.js.map
