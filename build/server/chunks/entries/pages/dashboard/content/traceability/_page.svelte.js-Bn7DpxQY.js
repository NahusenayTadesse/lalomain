...
//#region src/routes/dashboard/content/traceability/+page.svelte
	...
	$$renderer.component(($$renderer) => {
		...
		const fields = [
			...
			},
			{
				...
				label: "Detail",
				type: "textarea",
				placeholder: "e.g. 114 collection centers, weight and code records",
				rows: 3
			},
			{
				name: "icon",
...
//# sourceMappingURL=_page.svelte.js-Bn7DpxQY.js.map
