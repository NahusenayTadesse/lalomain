import { w as companyMilestones } from '../../../../../chunks/db.js-gHXkniRQ.js';
...
//#region src/routes/dashboard/content/milestones/schema.ts
var addSchema = object({
	page: string("Required").min(1, "Required"),
	period: string("Required").min(1, "Required").max(255),
	title: string("Required").min(1, "Required").max(255),
	description: string().optional(),
	sortOrder: sortOrderField
});
//#endregion
//#region src/routes/dashboard/content/milestones/+page.server.ts
...
//# sourceMappingURL=_page.server.ts.js-E6pIgPap.js.map
