...
//#region src/routes/dashboard/content/coffee-regions/+page.svelte
	...
	$$renderer.component(($$renderer) => {
		...
		const fields = [
			...
			},
			{
				...
				label: "Cupping notes",
				type: "text",
				placeholder: "Comma separated - each becomes a badge"
			},
			{
				name: "aroma",
				label: "Aroma",
...
//# sourceMappingURL=_page.svelte.js-Bm2pAfQl.js.map
